...
class TrabajosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabajo" do
    assert_difference("Trabajo.count") do
      post trabajos_url, params: { trabajo: { descripción: @trabajo.descripción, puesto: @trabajo.puesto } }
    end
  ...
  test "should update trabajo" do
    patch trabajo_url(@trabajo), params: { trabajo: { descripción: @trabajo.descripción, puesto: @trabajo.puesto } }
